...
public class Team<T extends Player> { // this is saying the parameterized type T, has to be a Player or a subtype of Player.
                                      // Player in this case could have been either a class or an interface, the syntax would be the same.
                                 //  This means that only subtypes of Player or a Player itself (if it were a class and not an interface)
