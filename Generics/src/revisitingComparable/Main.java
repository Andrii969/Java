...
//        System.out.println("result = " + tim.compareTo("Marry")); // ERROR: class java.lang.String cannot be cast to class
                                                                // revisitingComparable.Student
        // This is because my compareTo method on the Student class is trying to cast a String to a Student.
        // When you implement Comparable on a class, you should specify a type parameter to avoid potential Class Cast Exceptions like this.
