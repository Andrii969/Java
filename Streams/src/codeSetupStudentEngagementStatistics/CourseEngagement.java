...
public class CourseEngagement {
    ...
    private final Course course; // final get set on construction only
    ...
    public String getLastActivityMonth() { // %tb is the way to get the three character month abbreviation.
