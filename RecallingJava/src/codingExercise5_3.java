public class codingExercise5_3 {
    ...
    public static void printMegaBytesAndKiloBytes (int kiloBytes) {
        ...
        int megaBytesInKiloBytes = kiloBytes/1024;
        int remainingKiloBytes = kiloBytes % 1024;
        System.out.println(kiloBytes + " KB = " + megaBytesInKiloBytes + " MB and " + remainingKiloBytes + " KB");
    }
